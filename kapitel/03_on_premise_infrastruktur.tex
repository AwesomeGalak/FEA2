...
\begin{table}[H]
    ...
    \begin{tabular}{l l}
        ...
        Modell              & Qwen 3.5 9B \\
        STT                 & Parakeet TDT 0.6B (ONNX, lokal) \\
        \bottomrule
    \end{tabular}
...
größere Modelle skaliert. Die kritischen Hardware-Ressourcen für lokale
LLM-Inferenz sind \textbf{VRAM} (Modellgewichte + KV-Cache, vgl.
Tabelle~\ref{tab:quantisierung}) und \textbf{Speicherbandbreite}
(Memory-Bound-Betrieb). Das eingesetzte Qwen 3.5 9B kann mit einer
