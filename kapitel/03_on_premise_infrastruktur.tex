...
Der Grund für den Start des Aufschwungs des LLMs in den 2020er Jahren ist vor allem auf die 
Erfindung des Transformers zurückzuführen dieser Algorithmus machte es möglich anstatt wie vorher nur 
möglich eine operation gleichzeitig auszufühen konnten nun tausende parallel ausgeführt werden.
% ============================================================
...
\textbf{85.584 Parametern} zur Verfügung, das schrittweise --- von der
Tokenisierung bis zum Softmax-Ausgang --- alle Operationen zeigt.
